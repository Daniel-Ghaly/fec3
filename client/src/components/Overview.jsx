...
class Overview extends React.Component {
  ...
  componentDidMount() {
    axios.get(`https://sleepy-hamlet-84325.herokuapp.com/reviews`, { params: { product_id: this.props.product_Id }})
      .then(res => {
    ...
    axios.get(`https://sleepy-hamlet-84325.herokuapp.com/products/${this.props.product_Id}`)
      .then(res => {
    ...
    axios.get(`https://sleepy-hamlet-84325.herokuapp.com/products/${this.props.product_Id}/styles`)
      .then(res => {
  ...
  //   axios.get('http://127.0.0.1/reviews', { params: { product_id: this.props.product_Id }})
  //     .then(res => {
  //       this.setState({numberOfReviews: res.data.results.length});
  ...
  //   axios.get(`http://127.0.0.1/products/${this.props.product_Id}`)
  //     .then(res => {
  //       this.setState({productName: res.data.name});
  //       this.setState({productCategory: res.data.category});
  //       this.setState({productDescription: res.data.description});
  ...
  //   axios.get(`http://127.0.0.1/products/${this.props.product_Id}/styles`)
  //     .then(res => {
  //       // maintain styles API results in state, so that I can use it later in lifecycle
  //       this.setState({results: res.data.results});
  //       // initialize available sizes of default style
